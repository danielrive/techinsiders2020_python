        ...
        try:
            ...
            if data["id"] and data["name"]:
                try:
                    ...
                    body = {"message": "Book successfully created with id {}".format(data["id"])}
        ...
        try:
            if data["id"]:
                try:
                    ...
                    body = {"message": "Book with id {} was successfully updated".format(data["id"])}
                    response = make_response(body, 200)
                    response.headers['Content-Type'] = 'application/json'
                    return response
                    ...
                    print(str(e))
                    body = {"error": "There was an error updating the book. Please try again"}
                    response = make_response(body, 500)
                    response.headers['Content-Type'] = 'application/json'
                    return response
